<div class="miniature_box">
	<div class="miniature_pos">
		...
		<div class="miniature_text clear">
			...
			<div class="button_div fl_r" style="margin-top:-2px;margin-left:10px;line-height:15px" id="buttomDiv"><button onClick="imRoom.invite(this, {id})">Отправить приглашения</button></div>
		</div>
